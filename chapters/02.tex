...
Over the past few years, terminology management tools have been developed\linebreak specifically for interpreters, but the impact of such tools on the cognitive processes involved in simultaneous interpreting is still unclear. To this end, an exploratory study was conducted to evaluate the appropriateness of the stimuli adopted for data collection and to verify whether the use of computer-assisted interpreting tools causes saturation or, on the contrary, helps prevent it by reducing the local cognitive load during terminology search and delivery of the target text.}
\maketitle
...
\node [fit=(prandifig3-2-11)(prandifig3-2-12)] {responose};
...
\node [overlay,fit=(prandifig3-11-2)(prandifig3-12-2),rotate=90,text width=2.66cm,inner sep=0pt] {responose};
...
% \todo[inline]{ToDo for Langsci: Spacing between rows and columns, better rules!}
}
\end{figure}
...
\&  \& \node[rsma] (prandifig7-5-3) {$\emptyset$}; \& \node[rhea]{visual\linebreak spatial};    \& {0.8} \& {0.6} \& {0.6} \& {0.4} \& {0.7} \& {0.5} \& {0.4} \& 0.2\\
\&  \& \node[rsma] (prandifig7-6-3) {$\emptyset$}; \& \node[rhea]{visual\linebreak verbal};     \& {0.6} \& {0.8} \& {0.4} \& {0.6} \& {0.5} \& {0.7} \& {0.2} \& {0.4}\\
...
\node [fit=(prandifig7-2-11)(prandifig7-2-12)] {responose};
...
\node [overlay,fit=(prandifig7-11-2)(prandifig7-12-2),rotate=90,text width=2.66cm,inner sep=0pt] {responose};
...
\todo[inline]{Todo for LangSci: Spacing between rows and columns!}
}
\end{figure}
...
\&  \& \node[rsma] (prandifig6-5-3) {$\emptyset$}; \& \node[rhea]{visual\linebreak spatial};                       \& {0.8} \& {0.6} \& {0.6} \& {0.4} \& {0.7} \& {0.5} \& {0.4} \& {0.2}\\
\&  \& \node[rsma] (prandifig6-6-3) {$\emptyset$}; \& \node[rhea]{visual\linebreak verbal};                        \& {0.6} \& {0.8} \& {0.4} \& {0.6} \& {0.5} \& {0.7} \& {0.2} \& {0.4}\\
...
\&  \& \node[rsma] (prandifig6-11-3) {$\emptyset$}; \& \node[rhea]{response\linebreak spatial};                     \& {0.4} \& {0.2} \& {0.4} \& {0.2} \& {0.6} \& {0.4} \& {0.8} \& {0.6}\\
...
\node [fit=(prandifig6-2-11)(prandifig6-2-12)] {responose};
...
\node [overlay,fit=(prandifig6-11-2)(prandifig6-12-2),rotate=90,text width=2.66cm,inner sep=0pt] {responose};
...
The research project aims at answering three fundamental questions:
...
The test subjects’ deliveries were recorded with Audacity, while an \textsc{smi\linebreak red250m} eye-tracker was used to record pupillometry data. A \textsc{log} file, automatically created by InterpretBank, served as a reference to check what terms had been looked up by the test subjects. The same was done manually for the trials in which Word and Excel were adopted, using the Gaze Replay recordings. The interpretations were then transcribed using Partitur Editor, the transcription tool of the Exmaralda suite, and then analyzed. Before presenting the method used for this analysis and its results in \sectref{sec:prandi:5}, I will describe the main features of the speeches used for data collection, with a focus on stimuli distribution and morphological complexity.
...
Another goal of the research is to verify whether the use of a \textsc{cai} tool leads to better terminological quality in comparison to more traditional terminology management solutions, e.g. Word and Excel glossaries. First observations made in the sample are briefly discussed in \sectref{sec:prandi:5.2}, where I also provide a framework to analyze errors and omissions in relation to the tools used for glossary query.

\sectref{sec:prandi:5.3}
presents the results of my observations in relation to the strategies adopted by the test subjects to interpret the stimuli. Given the small size of the sample, with this exploratory study I aim at developing a methodology to be used for further research, rather than at drawing conclusions, which will require a larger dataset. 
...
After discussing the theoretical framework chosen for the study, I presented my main hypotheses on cognitive load during \textsc{si} with \textsc{cai}. In particular, I expected cognitive load to be higher during \textsc{si} with \textsc{cai} than during traditional \textsc{si}, but to be lower for \textsc{cai} tools such as InterpretBank than for traditional terminology management solutions like Word and Excel glossaries. I also expected the terminological quality to be better when a \textsc{cai} tool is used. While the hypotheses on cognitive load will require the analysis of pupillometry and eye-tracking measures to be verified, the analysis of the interpretations helped shed some light on the terminological quality of \textsc{si} performed with the support of \textsc{cai} tools and of traditional table glossaries. 
