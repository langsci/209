...
\&  \& \node[rsma] (prandifig6-12-3) {1};           \& \node[rhea]{response\linebreak verbal};   \& {0.2} \& {0.4} \& {0.2} \& {0.4} \& {0.4} \& {0.6} \& {0.6} \& {1.0}\\
};
...
\foreach \i in {5,6,8,10,11,12} \node [fit=(prandifig6-\i-3)(prandifig6-\i-12), fill=black!12,minimum height=1.4cm,yshift=-.5ex,inner ysep=0pt] {};
\foreach \j in {8,10} \node [fit=(prandifig6-3-\j)(prandifig6-12-\j), fill=black!12,minimum width=1.26cm,inner xsep=0pt] {};
