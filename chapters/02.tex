...
\foreach \j in {8,10} \node [fit=(prandifig3-3-\j)(prandifig3-12-\j), fill=black!12,minimum width=1.26cm,inner xsep=0pt] {};
...
\foreach \j in {8,10} \node [fit=(prandifig7-3-\j)(prandifig7-12-\j), fill=black!12,minimum width=1.26cm,inner xsep=0pt] {};
