...
\subsection{Hypotheses on SI with CAI}\label{sec:prandi:2.2}
...
\begin{figure}
	...
	\bfseries
		...
		\textbf{Read term}
\label{fig:prandi:4}\caption{Additional cognitive resources recruited during SI with a CAI tool/electronic glossary}
\end{figure}
...
\caption{\label{fig:prandi:5}Cognitive Resource Footprint for SI with a CAI tool/electronic glossary}
\end{figure}
...
\caption{Conflict matrix for SI with spreadsheet (Excel) TIC = 16.8\label{fig:prandi:7}}
\end{figure}

\begin{figure}
	%%please move the includegraphics inside the {figure} environment
	%%\includegraphics[width=\textwidth]{Ch2-img15.png}
\caption{Conflict matrix for SI with CAI (InterpretBank) TIC = 14.8\label{fig:prandi:6}}
\end{figure}

\section{Designing a pilot study on the use of CAI tools in the booth}\label{sec:prandi:3}
