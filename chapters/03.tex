...
\begin{figure}
	...
	\end{axis}
	\end{tikzpicture}
\caption{Distribution of perceptions of respondents on criteria\todo[inline]{do we need both caption and plot title?}}
\label{fig:deysel:2}
\end{figure}
...
\textbf{Berber, D.} 2010. The Use of Pedagogical and Non-pedagogical \textsc{ICT} in Conference Interpreter Training, in Pellat, V., Griffiths, K. \& Shao-Chuan, W. (eds.) \textit{Teaching and Testing Interpreting and Translating}. Peter Lang AG, International Academic Publishers: Bern. 229-249.
