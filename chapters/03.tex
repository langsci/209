...
The different exercises suggested by the developers are:\todo{converted from inline enumeration to list}
...
A copy of the questionnaire in its entirety is included in Addendum B.\todo{LangSci: Create proper link} The main section is discussed:
...
\end{axis}
\end{tikzpicture}
\caption{\label{fig:deysel:1}Means of absolute errors pre-experiment and post-experiment\todo[inline]{Please confirm graph}}
\end{figure}
...
\todo[inline]{Langsci: Rename Addendum => Appendix}
