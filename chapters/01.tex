...
Currently, existing CAI tools are mostly focused on terminological support, whether in preparing for an assignment or for access in the booth. This focus is not surprising - domain-specific terms are an important obstacle to interpreting quality, and CAI tools have the potential of helping interpreters use them more accurately and consistently. Recent studies (\citealt{Will2015}, \citealt{Fantinuoli2017a}, Costa et al. 2018) have surveyed existing CAI tools for terminology management, and determined relevant criteria to evaluate them. For a knowledge management tool to be practical in the booth, one important requirement is that it allows the interpreter to access reference material quickly and with as little additional cognitive load as possible. This can be achieved with good knowledge representation, clear presentation and ergonomic operation, and good search algorithms.

It is essential that relevant information can be retrieved fast, i.e. within the ear-voice span. Automatic Speech Recognition (ASR) has the potential of speeding up the look-up process and solving the cognitive effort and latency of manual querying. Technological advances in the field have been rapid in recent years, especially since the introduction of neural networks to solve the task (Yu, 2016). Given the current state of the art in ASR and its foreseeable progress, it seems to be a matter of time before the technology is used in CAI tools to support interpreters with terminology look-up, and/or with information-dense content like numbers, as explored in \citet{Fantinuoli2017b}. This paper will focus on the latter of these aspects. 

While the development and adoption of CAI tools has been limited, scientific research on the impact of their use has been even scarcer. The main contribution of this work is that it experimentally evaluates the potential impact of ASR-driven CAI support that displays numbers on-screen in real time.
...
\begin{stylecaption}
Figure : Example of the mock-up technological support, showing the three most recent numbers that have been pronounced by the speaker (Microsoft PowerPoint slide). New numbers are added to the bottom of the slide, with old numbers shifting upwards. A maximum of three numbers is shown.
\end{stylecaption}

\subsection{Participants}

The experiment was performed with ten interpretation students enrolled in the postgraduate program for Conference Interpreting at Ghent University with Dutch as an A-language. Seven of them had completed a 4-year applied linguistics program with a focus on French, the three others with a focus on German, making them proficient at the C2 level according to the CEFR framework (Council of \citealt{Europe2001}). At the time of the experiment, all participants had received 5 weeks of simultaneous training at the postgraduate level and were taking additional \textit{retour} classes for the source languages of the experiment. They were all graduates of a master program in interpreting that offers an introduction to simultaneous interpreting and limited practice. Participants were aged between 22 and 27 years and 9 of them were female. 
...
The numbers expressed in the experimental speeches were balanced over four categories: simple and complex whole numbers, decimals and dates. \figref{fig:key:2} shows the performance in terms of accuracy, categorized by these number types.
...
\caption{Average accuracy per number type in both experimental conditions}
\label{fig:key:2}
...
A total of 228 errors was observed in the experiment. \figref{fig:key:3} presents them separated by type.
...
Alessandrini, M. (1990). Translating Numbers in Consecutive Interpretation: An Experimental Study. \textit{The Interpreters’ Newsletter}, 3, 77-80.

Braun, S., \& Clarici, A. (1996). Inaccuracy for Numerals in Simultaneous Interpretation: Neurolinguistic and Neuropsychological Perspectives. \textit{The Interpreters’ Newsletter}, \textit{7}, 85–102.

Collard, C., \& Defrancq, B. (2017). Sex Differences in Simultaneous Interpreting: A Corpus-Based Study. Poster presented at the CIUTI \citealt{Forum2017}.

Corpas Pastor, G., \& Fern, L. (2016). A Survey of Interpreters’ Needs and Practices Related to Language Technology. \textit{Technical Report FFI2012-38881-MINECO/TI-DT-2016-1}. Málaga: University of Málaga.

Costa, H., Corpas Pastor, G., \& Durán-Muñoz, I. (2018). Assessing Terminology Management Systems for Interpreters. In G. Corpas Pastor \& I. Durán-Muñoz (Eds.), \textit{Trends in E-Tools and Resources for Translators and Interpreters} (pp. 57–84). Brill.

Council of Europe. (2001). Common European Framework of Reference for Languages: Learning, Teaching, Assessment. Cambridge, U.K.: Press Syndicate of the University of Cambridge.

Fantinuoli, C. (2012). Design and Implementation of a Terminology and Knowledge Management Software for Conference Interpreter. PhD thesis. Mainz: University of Mainz.

Fantinuoli, C. (2017a). Computer-Assisted Preparation in Conference Interpreting. \textit{Translation \& Interpreting}, 9(2), 24–37.

Fantinuoli, C. (2017b). Speech Recognition in the Interpreter Workstation. In \textit{Proceedings of the Translating and the Computer 39 Conference}. London.

Fantinuoli, C. (2018). Computer-Assisted Interpreting: Challenges and Future Perspectives. In G. Corpas Pastor \& I. Durán-Muñoz (Eds.), \textit{Trends in E-Tools and Resources for Translators and Interpreters} (pp. 153–174). Brill.

Gile, D. (1995). Basic Concepts and Models for Interpreter and Translator Training. Amsterdam: Benjamins.

Gile, D. (1999). Testing the Tight Rope Hypothesis in Simultaneous Interpreting – A Contribution. \textit{Hermes,} 23, 153-172.

Gile, D. (2009). Basic Concepts and Models in Translator and Interpreter Training. Amsterdam: Benjamins.

Goldsmith, J. (2017). A Comparative User Evaluation of Tablets and Tools for Consecutive Interpreters. \textit{Proceedings of Translating and the Computer} 39, 40-50.

Jones, R. (2002). Conference Interpreting Explained. Abingdon/New York: Routledge.

Korpal, P. (2016). Linguistic and Psychological Indicators of Stress in Simultaneous Interpreting. PhD thesis. Poznan: Adam Mickiewicz University.

Lamberger-Felber, H. (2001). Text-Oriented Research into Interpreting: Examples from a Case-Study. \textit{Hermes}, 26, 39-63.

Mazza, C. (2001). Numbers in Simultaneous Interpretation. \textit{The Interpreters’ Newsletter}, \textit{11}, 87–104.

Orlando, M. (2014). A Study on the Amenability of Digital Pen Technology in a Hybrid Mode of Interpreting: Consec-Simul with Notes. \textit{Translation and Interpreting}, 6(2), pp. 39-54.

Orlando, M. (2016). Training 21\textsuperscript{st} Century Translators and Interpreters: At the Crossroads of Practice, Research and Pedagogy. Berlin: Timme.

Pinochi, D. (2009). Simultaneous Interpretation of Numbers: Comparing German and English to Italian. An Experimental Study. \textit{The Interpreters’ Newsletter}, 14, 33–57.

Mead, P. (2015). Numbers. In F. Pöchhacker (Ed.) \textit{Routledge Encyclopedia of Interpreting Studies} (pp. 286-288). Abingdon/New York: Routledge.

Seeber, K. (2011). Cognitive Load in Simultaneous Interpreting: Existing Theories – New Models. \textit{Interpreting,} 13(2), 176-204.

Seeber, K. (2015). Simultaneous Interpreting. In H. Mikkelsen \& R. Jourdenais (eds.) \textit{The Routledge Handbook of Interpreting}. Oxon/New York: Routledge.

Seleskovitch D. (1975). \textit{Langage, Langue et Mémoire. Etude de la Prise de Notes en Interpretation Consécutive}, Paris, Minard Lettres Modernes. 

Setton, R. (1999). Simultaneous Interpretation. A Cognitive-Pragmatic Analysis. Amsterdam: Benjamins.

Timarová, S. (2012). Working Memory in Simultaneous Interpreting. PhD thesis. Antwerp: KULeuven.

Will, M. (2015). Zur Eignung Simultanfähiger Terminologiesysteme für das Konferenzdolmetschen. \textit{Zeitschrift Für Translationswissenschaft Und Fachkommunikation}, \textit{8}(1), 179–201.

Yu, D., \& Deng, L. (2016). \textit{Automatic Speech Recognition} (Signals an). London: Springer.
