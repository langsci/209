...
\&  \&  \&  \&  \& ~ \&  \&  \&  \&  \&  \&  \\  %\multicolumn{8}{c}{\isi{listening} \\& comprehension}\\
...
\node [fit=(prandifig3-1-5)(prandifig3-1-12)] {\isi{listening} \& comprehension};
...
\node [fit=(prandifig7-1-5)(prandifig7-1-12)] {\isi{listening} \& comprehension};
...
\node [fit=(prandifig6-1-5)(prandifig6-1-12)] {\isi{listening} \& comprehension};
...
The paper presented first results from an exploratory study aimed at developing a research methodology to investigate the use of computer-assisted interpreting tools during simultaneous interpreting. The pilot study is part of a PhD research project that aims at collecting data on both the procedural and the \isi{terminological} aspect of \textsc{si} with \textsc{cai}, combining product- and process-based measures. 
